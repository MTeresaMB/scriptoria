...
export const CharacterForm: React.FC<CharacterFormProps> = ({
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input
                ...
                onBlur={handleBlur}
                required
                className={`w-full mt-1 px-4 py-2 bg-slate-100 dark:bg-slate-700/50 border rounded-lg text-slate-900 dark:text-white placeholder-slate-500 dark:placeholder-slate-400 focus:outline-none focus:ring-2 ${fieldErrors.name && touchedFields.has('name')
                    ? 'border-red-500 focus:ring-red-500'
                    : 'border-slate-200 dark:border-slate-600 focus:ring-green-500'
                  }`}
              />
            ...
            <div>
              ...
              <input
                ...
                className="w-full mt-1 px-4 py-2 bg-slate-100 dark:bg-slate-700/50 border border-slate-200 dark:border-slate-600 rounded-lg text-slate-900 dark:text-white placeholder-slate-500 dark:placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-green-500"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                min={0}
                max={150}
                className={`w-full mt-1 px-4 py-2 bg-slate-100 dark:bg-slate-700/50 border rounded-lg text-slate-900 dark:text-white placeholder-slate-500 dark:placeholder-slate-400 focus:outline-none focus:ring-2 ${fieldErrors.age && touchedFields.has('age')
                    ? 'border-red-500 focus:ring-red-500'
                    : 'border-slate-200 dark:border-slate-600 focus:ring-green-500'
                  }`}
              />
            ...
            {/* Occupation */}
            <div>
              <label htmlFor="occupation" className="block text-sm font-medium text-slate-700 dark:text-slate-300">
                Occupation
              </label>
              <input
                id="occupation"
            ...
            {/* Birth */}
            <div>
              <label htmlFor="birth" className="block text-sm font-medium text-slate-700 dark:text-slate-300">
                Birth Date/Place
              </label>
              <input
                id="birth"
            ...
            {/* Relationship Status */}
            <div>
              <label htmlFor="relationship_status" className="block text-sm font-medium text-slate-700 dark:text-slate-300">
                Relationship Status
              </label>
              <input
        ...
        <div className="border-b border-slate-200 dark:border-slate-700 pb-6">
          <h3 className="text-lg font-semibold text-slate-900 dark:text-white mb-4">Physical Description</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {/* Height */}
            <div>
            ...
            {/* Build */}
            <div>
              <label htmlFor="build" className="block text-sm font-medium text-slate-700 dark:text-slate-300">
                Build
              </label>
              <input
                id="build"
            ...
            {/* Hair Color */}
            <div>
              <label htmlFor="hair_color" className="block text-sm font-medium text-slate-700 dark:text-slate-300">
                Hair Color
              </label>
              <input
                id="hair_color"
            ...
            {/* Hair Style */}
            <div>
              <label htmlFor="hair_style" className="block text-sm font-medium text-slate-700 dark:text-slate-300">
                Hair Style
              </label>
              <input
                id="hair_style"
            ...
            {/* Eye Color */}
            <div>
              <label htmlFor="eye_color" className="block text-sm font-medium text-slate-700 dark:text-slate-300">
                Eye Color
              </label>
              <input
                id="eye_color"
            ...
            {/* Eye Shape */}
            <div>
              <label htmlFor="eye_shape" className="block text-sm font-medium text-slate-700 dark:text-slate-300">
                Eye Shape
              </label>
              <input
                id="eye_shape"
            ...
            {/* Scars */}
            <div>
              <label htmlFor="scars" className="block text-sm font-medium text-slate-700 dark:text-slate-300">
                Scars/Marks
              </label>
              <input
                id="scars"
        ...
        {/* Personality & Traits */}
        <div className="border-b border-slate-200 dark:border-slate-700 pb-6">
          <h3 className="text-lg font-semibold text-slate-900 dark:text-white mb-4">Personality & Traits</h3>
          <div className="space-y-4">
            {/* Positive Traits */}
            <div>
              <label htmlFor="positive_traits" className="block text-sm font-medium text-slate-700 dark:text-slate-300">
                Positive Traits
              </label>
              <input
                id="positive_traits"
            ...
            {/* Negative Traits */}
            <div>
              <label htmlFor="negative_traits" className="block text-sm font-medium text-slate-700 dark:text-slate-300">
                Negative Traits
              </label>
              <input
                id="negative_traits"
            ...
            {/* Personality Type */}
            <div>
              <label htmlFor="personality_type" className="block text-sm font-medium text-slate-700 dark:text-slate-300">
                Personality Type
              </label>
              <input
                id="personality_type"
            ...
            {/* Quirks & Mannerisms */}
            <div>
              <label htmlFor="quirks_mannerisms" className="block text-sm font-medium text-slate-700 dark:text-slate-300">
                Quirks & Mannerisms
              </label>
              <textarea
        ...
        {/* Motivations & Flaws */}
        <div className="border-b border-slate-200 dark:border-slate-700 pb-6">
          <h3 className="text-lg font-semibold text-slate-900 dark:text-white mb-4">Motivations & Flaws</h3>
          <div className="space-y-4">
            {/* External Motivation */}
            <div>
              <label htmlFor="external_motivation" className="block text-sm font-medium text-slate-700 dark:text-slate-300">
                External Motivation
              </label>
              <textarea
            ...
            {/* Internal Motivation */}
            <div>
              <label htmlFor="internal_motivation" className="block text-sm font-medium text-slate-700 dark:text-slate-300">
                Internal Motivation
              </label>
              <textarea
            ...
            {/* Flaw */}
            <div>
              <label htmlFor="flaw" className="block text-sm font-medium text-slate-700 dark:text-slate-300">
                Fatal Flaw
              </label>
              <textarea
                id="flaw"
            ...
            {/* Fears & Phobias */}
            <div>
              <label htmlFor="fears_phobias" className="block text-sm font-medium text-slate-700 dark:text-slate-300">
                Fears & Phobias
              </label>
              <textarea
                id="fears_phobias"
            ...
            {/* Motto */}
            <div>
              <label htmlFor="motto" className="block text-sm font-medium text-slate-700 dark:text-slate-300">
                Motto / Catchphrase
              </label>
              <input
                id="motto"
        ...
        {/* Biography */}
        <div className="border-b border-slate-200 dark:border-slate-700 pb-6">
          <h3 className="text-lg font-semibold text-slate-900 dark:text-white mb-4">Biography</h3>
          <div>
            <label htmlFor="biography" className="block text-sm font-medium text-slate-700 dark:text-slate-300">
              Character Biography
            </label>
            <textarea
              id="biography"
              ...
              className={`w-full mt-1 px-4 py-2 bg-slate-100 dark:bg-slate-700/50 border rounded-lg text-slate-900 dark:text-white placeholder-slate-500 dark:placeholder-slate-400 focus:outline-none focus:ring-2 ${fieldErrors.biography && touchedFields.has('biography')
                  ? 'border-red-500 focus:ring-red-500'
                  : 'border-slate-200 dark:border-slate-600 focus:ring-green-500'
                }`}
            />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <select
                ...
                onChange={handleInputChange}
                className="w-full mt-1 px-4 py-2 bg-slate-100 dark:bg-slate-700/50 border border-slate-200 dark:border-slate-600 rounded-lg text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-green-500"
              >
