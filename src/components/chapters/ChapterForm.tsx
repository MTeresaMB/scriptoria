      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="border-b border-slate-200 dark:border-slate-700 pb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <label htmlFor="name_chapter" className="block text-sm font-medium text-slate-700 dark:text-slate-300">
                Title *
              </label>
              <input
                id="name_chapter"
                ...
                onBlur={handleBlur}
                required
                className={`w-full mt-1 px-4 py-2 bg-slate-100 dark:bg-slate-700/50 border rounded-lg text-slate-900 dark:text-white placeholder-slate-500 dark:placeholder-slate-400 focus:outline-none focus:ring-2 ${fieldErrors.name_chapter && touchedFields.has('name_chapter')
            ...
            <div>
              <label htmlFor="chapter_number" className="block text-sm font-medium text-slate-700 dark:text-slate-300">
                Chapter number
              </label>
              <input
                id="chapter_number"
