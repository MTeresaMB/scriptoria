      ...
      <div className="flex items-center justify-between gap-2">
        <div className="flex items-center gap-3 min-w-0">
          {onOpenSidebar && (
            <button
              ...
              className="md:hidden p-2 rounded-lg hover:bg-slate-700 text-slate-400 hover:text-white shrink-0"
        ...
        <div className="flex items-center space-x-4">
          ...
          <button
            ...
            className="flex items-center gap-2 px-3 md:px-4 py-2 bg-slate-700 border border-slate-600 rounded-lg text-slate-400 hover:text-white hover:border-slate-500 w-40 md:w-64 text-left shrink-0"
          >
            <Search className="w-4 h-4 shrink-0" />
            <span>Search...</span>
            <kbd className="ml-auto text-xs px-2 py-0.5 bg-slate-600 rounded">⌘K</kbd>
          </button>
