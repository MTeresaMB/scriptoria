...
export const EditorToolbar: React.FC<EditorToolbarProps> = ({ editor }) => {
  ...
  return (
    <div className="flex items-center gap-1 p-2 border-b border-slate-200 dark:border-slate-700 bg-slate-100 dark:bg-slate-800 rounded-none">
      {/* Text Formatting */}
      ...
      <div className="flex items-center gap-1 border-r border-slate-200 dark:border-slate-700 pr-2 mr-2">
        <button
          ...
          className={`p-2 rounded hover:bg-slate-200 dark:hover:bg-slate-700 transition-colors ${
            editor.isActive({ textAlign: 'left' }) ? 'bg-slate-200 dark:bg-slate-700 text-purple-600 dark:text-purple-400' : 'text-slate-600 dark:text-slate-300'
          }`}
          title="Align Left"
        >
        ...
        <button
          ...
          className={`p-2 rounded hover:bg-slate-200 dark:hover:bg-slate-700 transition-colors ${
            editor.isActive({ textAlign: 'center' }) ? 'bg-slate-200 dark:bg-slate-700 text-purple-600 dark:text-purple-400' : 'text-slate-600 dark:text-slate-300'
          }`}
          title="Align Center"
        >
        ...
        <button
          ...
          className={`p-2 rounded hover:bg-slate-200 dark:hover:bg-slate-700 transition-colors ${
            editor.isActive({ textAlign: 'right' }) ? 'bg-slate-200 dark:bg-slate-700 text-purple-600 dark:text-purple-400' : 'text-slate-600 dark:text-slate-300'
          }`}
          title="Align Right"
        >
        ...
        <button
          ...
          className={`p-2 rounded hover:bg-slate-200 dark:hover:bg-slate-700 transition-colors ${
            editor.isActive({ textAlign: 'justify' }) ? 'bg-slate-200 dark:bg-slate-700 text-purple-600 dark:text-purple-400' : 'text-slate-600 dark:text-slate-300'
          }`}
          title="Justify"
        >
      ...
      <div className="flex items-center gap-1">
        <button
          ...
          className="p-2 rounded hover:bg-slate-200 dark:hover:bg-slate-700 transition-colors text-slate-300 disabled:opacity-50 disabled:cursor-not-allowed"
          title="Undo (Ctrl+Z)"
        >
