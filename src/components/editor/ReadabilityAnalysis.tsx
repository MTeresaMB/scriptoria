    ...
    <div className={`space-y-4 ${className}`}>
      ...
      <div className="bg-slate-700/50 rounded-lg p-3">
        <div className="flex items-center justify-between mb-2">
          <span className="text-xs text-slate-400">Readability Score</span>
      ...
      <div className="bg-slate-700/50 rounded-lg p-3">
        <div className="flex items-center gap-2 mb-3">
          ...
          <span className="text-xs text-slate-400">Dialogue vs Narration</span>
        </div>
        <div className="space-y-2">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              <MessageSquare className="w-3 h-3 text-purple-400" />
              <span className="text-xs text-slate-300">Dialogue</span>
            </div>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs text-slate-300">Narration</span>
            </div>
            <span className="text-xs text-white font-medium">{narrationPercentage}%</span>
          </div>
