    ...
    <div className="p-6 max-w-2xl mx-auto">
      ...
      <div className="space-y-6">
        ...
        <div className="bg-slate-800 border border-slate-700 rounded-lg p-6">
          ...
          <form onSubmit={handleUpdateDisplayName} className="flex items-center gap-4">
            ...
            <div className="flex-1 min-w-0">
              <label htmlFor="displayName" className="block text-xs text-slate-400 mb-1">
                Display name
              </label>
              <input
                id="displayName"
        ...
        >
          ...
          <div>
            <label htmlFor="confirm" className="block text-xs text-slate-400 mb-1">
              Confirm Password
            </label>
            <input
              id="confirm"
